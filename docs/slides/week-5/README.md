# Week 5 Slides — Coffee Shop Course

Slidev deck สำหรับ Week 5 ⭐ (Session 1 + Session 2 — Inventory, atomic stock deduct, reports + dashboard).

## Run

```bash
cd docs/slides/week-5
npm install
...
เนื้อหามาจาก [`docs/instructor/week-5/slides-outline.md`](../../instructor/week-5/slides-outline.md).
