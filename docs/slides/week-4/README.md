# Week 4 Slides — Coffee Shop Course

Slidev deck สำหรับ Week 4 (Session 1 + Session 2 — Order flow, atomic transaction, kitchen UI).

## Run

```bash
cd docs/slides/week-4
npm install
...
เนื้อหามาจาก [`docs/instructor/week-4/slides-outline.md`](../../instructor/week-4/slides-outline.md).
