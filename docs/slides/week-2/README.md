# Week 2 Slides — Coffee Shop Course

Slidev deck สำหรับ Week 2 (Session 1 + Session 2 — Backend Setup, Database, Auth).

## Run

```bash
cd docs/slides/week-2
npm install
...
เนื้อหามาจาก [`docs/instructor/week-2/slides-outline.md`](../../instructor/week-2/slides-outline.md).
