# Week 6 Slides — Coffee Shop Course

Slidev deck สำหรับ Week 6 (Session 1 + Session 2 — VPS deploy, Docker, Caddy, GitOps + course closing).

## Run

```bash
cd docs/slides/week-6
npm install
...
เนื้อหามาจาก [`docs/instructor/week-6/slides-outline.md`](../../instructor/week-6/slides-outline.md).
