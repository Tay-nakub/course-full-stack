...
| Item | Note |
|---|---|
| Student ทุกคนทำ Tasks 1-4 จบไหม? | ___ |
| Block ไหน over-run? | ___ |
| Concept ไหนติด — Session 2 ต้องทบทวน? | ___ |
| Common mistake ที่เจอ | ___ |
| Student ที่ดูเหนื่อย / ตามไม่ทัน | ___ (DM ก่อน Session 2) |
