...
| Item                                           | Note   |
| ---------------------------------------------- | ------ |
| KPI dashboard ทุกคนเห็น real numbers?          | \_\_\_ |
| Recharts setup ติดที่ใคร?                      | \_\_\_ |
| Recipe editor — UI complete?                   | \_\_\_ |
| Block ไหน over-run มากสุด?                     | \_\_\_ |
| Pre-Week 6: Docker Desktop installed everyone? | \_\_\_ |
