...
| ----------------------------- | --------------------------------------- | ----------------------------------- |
| **WSL**                       | `ms-vscode-remote.remote-wsl`           | ✅ — ทำให้ VS Code edit code ใน WSL |
| **ESLint**                    | `dbaeumer.vscode-eslint`                | ✅ — lint errors                    |
...
| **Prisma**                    | `Prisma.prisma`                         | ✅ — `.prisma` file support         |
| **ES7+ React/Redux snippets** | `dsznajder.es7-react-js-snippets`       | ✅ — `rafce` / `useState` snippets   |
| **GitLens**                   | `eamodio.gitlens`                       | ✅ — git blame + history             |
| **vscode-icons**              | `vscode-icons-team.vscode-icons`        | ✅ — file/folder icons               |
| **Code Spell Checker**        | `streetsidesoftware.code-spell-checker` | ✅ — กัน typo                        |

#### Quick install (one command)

เปิด **WSL terminal** แล้ว paste:
...
> 💡 **Tip — รองรับภาษาไทยใน Code Spell Checker**
> Bracket `cSpell.ignoreRegExpList` ด้านบนสั่งให้ spell-checker **ข้ามตัวอักษรที่ไม่ใช่ ASCII** (ภาษาไทย, จีน, ญี่ปุ่น ฯลฯ) → จะไม่มีเส้นหยักใต้คำว่า "สวัสดี" หรือ comment ภาษาไทย แต่ภาษาอังกฤษยังถูกตรวจ typo อยู่.
